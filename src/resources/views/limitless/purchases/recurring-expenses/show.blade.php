        ...
        <div class="sidebar-content" style="width: 389px;">
            ...
            <div class="panel panel-flat no-border ">
                ...
                <div class="table-responsive no-border datatable-invoices">
                    <table class="rg_datatable_sidebar table table-hover text-nowrap" data-ajax="{{route('accounting.purchases.recurring-expenses.datatables')}}" data-txn-id="{{$txn->id}}">
                        <thead class="hidden">
                        <tr>
            ...
            <div class="page-title clearfix text-right">
                ...
                <div class="btn-group pull-left mr-20">
                    ...
                    <ul class="dropdown-menu dropdown-menu-left">
                        ...
                        <li class="divider"></li>
                        <li><a href="{{route('accounting.purchases.recurring-expenses.destroy', $txn->id)}}" class="text-danger rg-ajax-accounting-sales-invoice-destroy" data-callback="{{route('accounting.purchases.recurring-expenses.index')}}"><i class="icon-trash"></i> Delete transaction</a></li>
                    </ul>
                </div>
                ...
                <div class="btn-group pull-right">
                    ...
                    <button data-href="{{route('accounting.purchases.recurring-expenses.edit', $txn->id)}}" type="button" class="btn btn-default btn-icon"><i class="icon-pencil3"></i></button>
                    ...
                    <a href="{{route('accounting.purchases.recurring-expenses.index')}}" class="btn btn-icon btn-default"><i class="icon-cross"></i> Back</a>
                </div>
        ...
        <div class="panel panel-flat no-border no-shadow">
            ...
            @if (empty($txn))
                <div class="panel-body">
                    <div class="col-md-8">
                        <button data-href="{{route('accounting.purchases.recurring-expenses.create')}}" type="button" class="btn btn-danger"><i class="icon-plus22"></i> New Invoice</button>
                        <hr/>
					...
					<div class="panel panel-white">
						<div class="panel-heading hidden-print">
							...
							<div class="heading-elements">
								<a href="{{route('accounting.purchases.recurring-expenses.copy', $txn->id)}}" class="btn btn-default btn-xs heading-btn"><i class="icon-file-check position-left"></i> Copy</a>
