    ...
    <div class="content-wrapper">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active">
                        <button type="button" class="btn btn-link text-primary text-semibold rg_datatable_selected_export_to_excel"
                            data-href="{{route('accounting.purchases.recurring-expenses.export-to-excel')}}">
            ...
            <div class="page-header-content">
                <div class="page-title clearfix">
                    <h1 class="pull-left no-margin text-light">
                        <i class="icon-file-plus position-left"></i> Recurring Expenses
                        <small>View and manage recurring expenses</small>
                    </h1>
                    <div class="pull-right">
                        <a href="{{route('accounting.purchases.recurring-expenses.create')}}" type="button" class="btn btn-danger pr-20"><i class="icon-plus22"></i> New Recurring Expense </a>
                    </div>
                </div>
            </div>
        ...
        <div class="content no-padding">
            ...
            <div class="panel panel-flat no-border no-shadow">
                ...
                <table class="rg-datatable-txns-table table datatable-pagination" data-ajax="{{route('accounting.purchases.recurring-expenses.datatables')}}">
                    <thead>
                    <tr>
                        <th class="" width="12"></th>
                        <th title="Copy Expense(s)"><i class="icon-files-empty2"></i></th>
                        <th>DATE</th>
                        <th>EXPENSE ACCOUNT</th>
                        <th>REFERENCE</th>
                        <th>SUPPLIER / VENDOR</th>
                        <th>PAID THROUGH</th>
                        <th class="text-uppercase">Supplier / Vendor</th>
