...
@section('title', 'Purchases :: Expense')
            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h1 class="no-margin text-light">
                        <i class="icon-file-plus position-left"></i> New Expense
        ...
        <div class="content no-border no-padding">
            ...
            <div class="panel panel-flat no-border no-shadow no-padding">
                ...
                <div class="panel-body no-padding">
                    ...
                    <form id="txn_form" action="{{route('accounting.purchases.expenses.store')}}" method="post" class="form-horizontal" autocomplete="off" style="margin-bottom: 100px;">
                        @csrf
                        @method('POST')
