...
@section('title', 'Purchase Order :: Create / Add')
            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h1 class="no-margin text-light">
                        <i class="icon-file-plus position-left"></i> Purchase Order
        ...
        <div class="content no-border no-padding">
            ...
            <div class="panel panel-flat no-border no-shadow no-padding">
                ...
                <div class="panel-body no-padding">
                    ...
                    <form id="txn_form" action="{{route('accounting.purchases.purchase-orders.store')}}" method="post" class="form-horizontal" style="margin-bottom: 100px;">
                        @csrf
                        @method('POST')
                        ...
                        <fieldset class="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="max-width-1040">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" name="reference" class="form-control input-roundless" placeholder="Enter reference">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="max-width-1040">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" name="date" value="" class="form-control input-roundless daterange-single" placeholder="Choose date">
                                    </div>
                                </div>
