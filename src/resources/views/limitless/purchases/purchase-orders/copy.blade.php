...
@section('title', 'Purchase Order :: Copy')
            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h1 class="no-margin text-light">
                        ...
                        <small>Copy purchase order.</small>
                    </h1>
                </div>
            </div>
        ...
        <div class="content no-border no-padding">
            ...
            <div class="panel panel-flat no-border no-shadow no-padding">
                ...
                <div class="panel-body no-padding">
                    ...
                    <form id="txn_form" action="{{route('accounting.purchases.purchase-orders.store')}}" method="post" class="form-horizontal" data-edit="true" style="margin-bottom: 100px;">
                        @csrf
                        @method('POST')
                        ...
                        <fieldset class="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="max-width-1040">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" name="delivery_date" value="{{$txn->delivery_date}}" class="form-control input-roundless daterange-single" placeholder="Choose date">
                                    </div>
                                </div>
