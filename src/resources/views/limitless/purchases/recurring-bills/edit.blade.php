        ...
        <div class="content no-border no-padding">
            ...
            <div class="panel panel-flat no-border no-shadow no-padding">
                ...
                <div class="panel-body no-padding">
                    ...
                    <form id="txn_form" action="{{route('accounting.purchases.recurring-bills.update', $txn->id)}}" method="post" class="form-horizontal" data-edit="true" style="margin-bottom: 100px;">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group">
                            <div class="max-width-1040">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" name="number" value="<?php echo $number; ?>" class="form-control input-roundless" placeholder="Invoice number">
                                </div>
                            </div>
                        </div>
                        */ ?>
                                    ...
                                    <table class="table table-bordered no-border-left no-border-right no-border-bottom">
                                        ...
                                        @foreach($txn->items as $key => $item)
                                            ...
                                            <tr id="row_{{$key}}">
                                                ...
                                                <td class="no-padding"><input type="text" data-row="{{$key}}" name="items[{{$key}}][quantity]" class="item_row_quantity form-control no-border text-right" value="<?php echo $item['quantity']; ?>"></td>
                                                <td class="no-padding"><input type="text" data-row="{{$key}}" name="items[{{$key}}][rate]" class="item_row_rate form-control m-input no-border text-right" value="<?php echo $item['rate']; ?>"></td>
                                                <td class="no-padding">
                ...
                <div class="navbar-collapse collapse" id="navbar-second">
                    ...
                    <div class="navbar-text">
                        ...
                        <div class="btn-group dropup btn-xs btn-group-animated no-padding mr-20">
                            <button type="button" class="btn btn-danger btn-xs pr-20 pl-20 submit_txn_form" data-onsuccess="send"><i class="icon-cog5 position-left"></i> Update {{$entree->name}}</button>
                        </div>
