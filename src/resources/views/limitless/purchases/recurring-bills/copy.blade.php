...
@section('title', 'Recurring Bill :: Copy')
        ...
        <div class="content no-border no-padding">
            ...
            <div class="panel panel-flat no-border no-shadow no-padding">
                ...
                <div class="panel-body no-padding">
                    ...
                    <form id="txn_form" action="{{route('accounting.purchases.recurring-bills.store')}}" method="post" class="form-horizontal" data-edit="true" style="margin-bottom: 100px;">
                        @csrf
                        @method('POST')
