    ...
    <div class="content-wrapper">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active">
                        <button type="button" class="btn btn-link text-primary text-semibold rg_datatable_selected_export_to_excel"
                            data-url="{{route('accounting.purchases.recurring-bills.export-to-excel')}}">
            ...
            <div class="page-header-content">
                <div class="page-title clearfix">
                    <h1 class="pull-left no-margin text-light">
                        <i class="icon-file-plus position-left"></i> Recurring Bills
                        <small></small>
                    </h1>
                    <div class="pull-right">
                        <a href="{{route('accounting.purchases.recurring-bills.create')}}" type="button" class="btn btn-danger pr-20"><i class="icon-plus22"></i> New Recurring Bill </a>
                    </div>
                </div>
            </div>
        ...
        <div class="content no-padding">
            ...
            <div class="panel panel-flat no-border no-shadow">
                ...
                <table class="rg-datatable-txns-table table datatable-pagination" data-ajax="{{route('accounting.purchases.recurring-bills.datatables')}}">
                    <thead>
                    <tr>
                        <th width="12"></th>
                        <th>DATE</th>
