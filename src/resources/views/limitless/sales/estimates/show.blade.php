    ...
    <div class="sidebar sidebar-secondary sidebar-default sidebar-fixed" style="width: 390px;">
        <div class="sidebar-content" style="width: 389px;">
                    ...
                    <div class="page-title clearfix">
                        ...
                        <div id="quick-sort" class="btn-group pull-left">
                            <a href="#" class="btn btn-link dropdown-toggle text-semibold" data-toggle="dropdown" aria-expanded="true">
                                <span class="dropdown-title">All Estimates</span>
                                <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-left dropdown-menu-xs no-border-radius">
                                <li><a href="#" data-ajax="/datatable/transactions/entree/estimate/?status=client+viewed">Client viewed</a></li>
                                <li><a href="#" data-ajax="/datatable/transactions/entree/estimate/?status=processed">Processed</a></li>
                                <li class="divider"></li>
                                <li><a href="#" data-ajax="/datatable/transactions/entree/estimate/">All Estimates</a></li>
                            </ul>
                        </div>

                        <button data-href="{{route('accounting.sales.estimates.create')}}" type="button" class="btn btn-danger btn-sm pull-right"><i class="icon-plus22"></i> New</button>
            ...
            <div class="panel panel-flat no-border ">
                ...
                <table class="rg_datatable_sidebar table table-hover text-nowrap" data-ajax="{{route('accounting.sales.estimates.datatables')}}" data-txn-id="{{$txn->id}}">
            ...
            <div class="page-title clearfix text-right">
                ...
                <div class="btn-group pull-left mr-20">
                    ...
                    <ul class="dropdown-menu dropdown-menu-left">
                        ...
                        <li class="divider"></li>
                        <li><a href="{{route('accounting.sales.estimates.destroy', $txn->id)}}" class="text-danger rg-ajax-accounting-sales-estimate-destroy" data-callback="{{route('accounting.sales.estimates.index')}}"><i class="icon-trash"></i> Delete transaction</a></li>
                    </ul>
                </div>
                ...
                <form action="{{route('accounting.sales.estimates.process', $txn->id)}}" method="post" class="pull-right mr-10">
                    @csrf
                    @method('POST')
