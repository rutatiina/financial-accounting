            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h1 class="no-margin text-light">
                        ...
                        <small>Edit estimate to clients.</small>
                    </h1>
                </div>
            </div>
        ...
        <div class="content no-border no-padding">
            ...
            <div class="panel panel-flat no-border no-shadow no-padding">
                ...
                <div class="panel-body no-padding">
                    ...
                    <form id="txn_form" action="{{route('accounting.sales.estimates.update', $txn->id)}}" method="post" class="form-horizontal" style="margin-bottom: 100px;" data-edit="true">
                                ...
                                <div class="max-width-1040">
                                    <table class="table table-bordered no-border-left no-border-right no-border-bottom">
                                        ...
                                        <tr class="items_row_template hidden">
                                            ...
                                            <td class="no-padding">
                                                <select class="item_row_tax rg_tax_selector" data-row="" data-minimum-Results-For-Search="-1" data-placeholder="Select" data-allow-clear="true">
                                                    <option></option>
                ...
                <div class="navbar-collapse collapse" id="navbar-second">
                    ...
                    <div class="navbar-text">
                        ...
                        <div class="btn-group dropup btn-xs btn-group-animated no-padding mr-20">
                            <button type="button" class="btn btn-danger btn-xs pr-20 pl-20 submit_txn_form" data-onsuccess="{{route('accounting.sales.estimates.show', $txn->id)}}"><i class="icon-books position-left"></i> Update {{$entree->name}}</button>
                            {{--
                            <button type="button" class="btn btn-danger btn-xs dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></button>
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="" class="submit_txn_form" data-onsuccess="send"><i class="icon-screen-full"></i> Edit and send</a></li>
                                <li class="divider"></li>
                                <li><a href="" class="submit_txn_form" data-onsuccess="draft"><i class="icon-gear"></i> Edit as draft</a></li>
                            </ul>
                            --}}
                        </div>
