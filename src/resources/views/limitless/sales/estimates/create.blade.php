            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h1 class="no-margin text-light">
                        ...
                        <span class="label label-primary ml-20">{{auth()->user()->tenant->name}}</span>
                        {{--<small>An estimate is a quote or a proposal for the products you sell or the services you render to your clients to take your business forward.</small>--}}
                    </h1>
                </div>
            </div>
        ...
        <div class="content no-border no-padding">
            ...
            <div class="panel panel-flat no-border no-shadow no-padding">
                ...
                <div class="panel-body no-padding">
                    ...
                    <form id="txn_form" action="{{route('accounting.sales.estimates.store')}}" method="post" class="form-horizontal" style="margin-bottom: 100px;">
                                ...
                                <div class="max-width-1040">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="expiry_date" value="" class="form-control input-roundless daterange-single" placeholder="Expiry date" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="navbar-collapse collapse" id="navbar-second">
                    ...
                    <div class="navbar-text">
                        ...
                        <div class="btn-group dropup btn-xs btn-group-animated no-padding mr-20">
                            <button type="button" class="btn btn-danger btn-xs pr-20 pl-20 submit_txn_form" data-onsuccess=""><i class="icon-books position-left"></i> Create {{$entree->name}}</button>
                            {{--
