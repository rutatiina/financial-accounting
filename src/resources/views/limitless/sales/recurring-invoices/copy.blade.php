...
@section('title', 'Recurring Invoice :: Edit')
            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h1 class="no-margin text-light">
                        <i class="icon-file-plus position-left"></i> Recurring Invoice
                        <small>Edit Recurring Invoice.</small>
                    </h1>
                </div>
            </div>
        ...
        <div class="content no-border no-padding">
            ...
            <div class="panel panel-flat no-border no-shadow no-padding">
                ...
                <div class="panel-body no-padding">
                    ...
                    <form id="txn_form" action="{{route('accounting.sales.recurring-invoices.store')}}" method="post" class="form-horizontal" data-edit="true" style="margin-bottom: 100px;">
                        ...
                        <fieldset class="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="max-width-1040">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" name="reference" value="{{$txn->reference}}" class="form-control input-roundless" placeholder="Enter reference / Order No.">
                                    </div>
                                </div>
                                            ...
                                            <tr id="row_{{$key}}">
                                                <td class="td_item_selector no-padding rg_select2_border_none">
                                                    <select class="item_row_item rg_item_selector"
                                                            ...
                                                            data-allow-clear="true"
                                                            data-url="{{route('items.select2-data.sales')}}">
                                                        <?php if (empty($item['type']) && $item->name) { ?>
                ...
                <div class="navbar-collapse collapse" id="navbar-second">
                    ...
                    <div class="navbar-text">
                        ...
                        <div class="btn-group dropup btn-xs btn-group-animated no-padding mr-20">
                            <button type="button" class="btn btn-danger btn-xs pr-20 pl-20 submit_txn_form" data-onsuccess="{{route('accounting.sales.recurring-invoices.show', $txn->id)}}"><i class="icon-cog5 position-left"></i> Create {{$entree->name}}</button>
                            {{--
