        ...
        <div class="sidebar-content" style="width: 389px;">
                    ...
                    <div class="page-title clearfix">
                        ...
                        <div id="quick-sort" class="btn-group pull-left">
                            <a href="#" class="btn btn-link dropdown-toggle text-semibold" data-toggle="dropdown" aria-expanded="true">
                                <span class="dropdown-title">All Recurring Invoices</span>
                                <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-left dropdown-menu-xs no-border-radius">
                                <li><a href="#" data-ajax="/datatable/transactions/entree/recurring_invoice/?status=client+viewed">Client viewed</a></li>
                                <li class="divider"></li>
                                <li><a href="#" data-ajax="/datatable/transactions/entree/recurring_invoice/">All Recurring Invoices</a></li>
                            </ul>
                        </div>

                        <button data-href="/sales/recurring_invoice/" type="button" class="btn btn-danger btn-sm pull-right"><i class="icon-plus22"></i> New</button>
            ...
            <div class="panel panel-flat no-border ">
                ...
                <div class="table-responsive no-border datatable-invoices">
                    <table class="rg_datatable_sidebar table table-hover text-nowrap" data-ajax="{{route('accounting.sales.recurring-invoices.datatables')}}" data-txn-id="{{$txn->id}}">
                        <thead class="hidden">
                        <tr>
            ...
            <div class="page-title clearfix text-right">
                ...
                <div class="btn-group pull-left mr-20">
                    ...
                    <ul class="dropdown-menu dropdown-menu-left">
                        ...
                        <li class="divider"></li>
                        <li><a href="{{route('accounting.sales.recurring-invoices.destroy', $txn->id)}}" class="text-danger rg-ajax-accounting-sales-recurring-invoice-destroy" data-callback="{{route('accounting.sales.recurring-invoices.index')}}"><i class="icon-trash"></i> Delete transaction</a></li>
                    </ul>
                </div>
                ...
                <div class="btn-group pull-right">
                    <button data-href="{{route('accounting.sales.recurring-invoices.create')}}" type="button" class="btn btn-danger"><i class="icon-plus22"></i> New Recurring Invoice</button>
                    <button data-href="{{route('accounting.sales.recurring-invoices.edit', $txn->id)}}" type="button" class="btn btn-default btn-icon"><i class="icon-pencil3"></i></button>
                    ...
                    <a href="{{route('accounting.sales.recurring-invoices.index')}}" class="btn btn-icon btn-default"><i class="icon-cross"></i> Back</a>
                </div>
