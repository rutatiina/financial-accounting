...
@section('title', 'Recurring Invoice :: Create / Add')
        ...
        <div class="content no-border no-padding">
            ...
            <div class="panel panel-flat no-border no-shadow no-padding">
                ...
                <div class="panel-body no-padding">
                    ...
                    <form id="txn_form" action="{{route('accounting.sales.recurring-invoices.store')}}" method="post" class="form-horizontal" style="margin-bottom: 100px;">
