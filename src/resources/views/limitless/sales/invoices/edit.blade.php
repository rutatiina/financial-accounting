            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h1 class="no-margin text-light">
                        ...
                        <small>Edit Invoices for products sold or services to contact(s).</small>
                    </h1>
                </div>
            </div>
        ...
        <div class="content no-border no-padding">
            ...
            <div class="panel panel-flat no-border no-shadow no-padding">
                ...
                <div class="panel-body no-padding">
                    ...
                    <form id="txn_form" action="{{route('accounting.sales.invoices.update', $txn->id)}}" method="post" class="form-horizontal" data-edit="true" style="margin-bottom: 100px;">
                        ...
                        <fieldset class="" style="background: #fcfcfc; border-top: 1px solid #ddd; border-bottom: 1px solid #eee;">
                            ...
                            <div class="form-group">
                                <div class="max-width-1040">
                                    ...
                                    <div id="contact_currency" class="col-lg-1 no-padding-left {{(empty(optional($txn->debit_contact)->currency)) ? 'hidden__' : ''}}">
                                ...
                                <div class="max-width-1040">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <span class="input-group-addon label-roundless">
                                            ...
                                            <input type="text" name="due_date" value="{{$txn->due_date ? $txn->due_date : (date('Y-m-d'))}}" class="form-control input-roundless daterange-single-empty" placeholder="Due date">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-bordered no-border-left no-border-right no-border-bottom">
                                        ...
                                        @foreach($txn->items as $key => $item)
                                            ...
                                            <tr id="row_{{$key}}">
                                                ...
                                                <td class="no-padding"><input type="text" data-row="{{$key}}" name="items[{{$key}}][discount]" class="item_row_discount form-control no-border text-right" value="0"></td>
                                                <td class="no-padding">
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-15 no-border-right text-bold size4of5" colspan="3">TOTAL (<span id="txn_base_currency">{{$txn->base_currency}}</span>)</td>
                ...
                <div class="navbar-collapse collapse" id="navbar-second">
                    ...
                    <div class="navbar-text">
                        ...
                        <div class="btn-group dropup btn-xs btn-group-animated no-padding mr-20">
                            <button type="button" class="btn btn-danger btn-xs pr-20 pl-20 submit_txn_form" data-onsuccess="{{route('accounting.sales.invoices.show', $txn->id)}}"><i class="icon-books position-left"></i> Update {{$entree->name}}</button>
                            {{--
