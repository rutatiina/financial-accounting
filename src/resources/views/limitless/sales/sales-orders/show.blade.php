        ...
        <div class="sidebar-content" style="width: 389px;">
                    ...
                    <div class="page-title clearfix">
                        ...
                        <div id="quick-sort" class="btn-group pull-left">
                            <a href="#" class="btn btn-link dropdown-toggle text-semibold" data-toggle="dropdown" aria-expanded="true">
                                <span class="dropdown-title">All Sales Orders</span>
                                <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-left dropdown-menu-xs no-border-radius">
                                <li><a href="#" data-ajax="/datatable/transactions/entree/sales_order/?status=client+viewed">Client viewed</a></li>
                                <li><a href="#" data-ajax="/datatable/transactions/entree/sales_order/?status=processed">Processed</a></li>
                                <li class="divider"></li>
                                <li><a href="#" data-ajax="/datatable/transactions/entree/sales_order/">All Sales Orders</a></li>
                            </ul>
                        </div>

                        <button data-href="/sales/sales_order/" type="button" class="btn btn-danger pull-right"><i class="icon-plus22"></i> New</button>
            ...
            <div class="panel panel-flat no-border ">
                ...
                <div class="table-responsive no-border datatable-invoices">
                    <table class="rg_datatable_sidebar table table-hover text-nowrap" data-ajax="{{route('accounting.sales.sales-orders.datatables')}}" data-txn-id="{{$txn->id}}">
                        <thead class="hidden">
                        <tr>
                            <th>SALES ORDERS</th>
            ...
            <div class="page-title clearfix text-right">
                ...
                <div class="btn-group pull-left mr-20">
                    ...
                    <ul class="dropdown-menu dropdown-menu-left">
                        ...
                        <li class="divider"></li>
                        <li><a href="{{route('accounting.sales.sales-orders.destroy', $txn->id)}}" class="text-danger rg-ajax-accounting-sales-sales-order-destroy" data-callback="{{route('accounting.sales.sales-orders.index')}}"><i class="icon-trash"></i> Delete transaction</a></li>
                    </ul>
                </div>
                ...
                <div class="btn-group pull-right">
                    <button data-href="{{route('accounting.sales.estimates.edit', $txn->id)}}" type="button" class="btn btn-default btn-icon"><i class="icon-pencil3"></i></button>
                    ...
                    <a href="{{route('accounting.sales.sales-orders.index')}}" class="btn btn-icon btn-default"><i class="icon-cross"></i> Back</a>
                </div>

                <form action="{{route('accounting.sales.sales-orders.process', $txn->id)}}" method="post" class="pull-right mr-10">
                    @csrf
                    @method('POST')
                    <input type="hidden" name="txn_id" value="{{$txn->id}}">
                    <input type="hidden" name="process_to" value="invoice">
                    <button type="submit" class="btn btn-danger"><i class="icon-chevron-right"></i> Convert to Invoice</button>
                </form>
