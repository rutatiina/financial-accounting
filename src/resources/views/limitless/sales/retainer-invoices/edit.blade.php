...
@section('title', 'Retainer Invoice :: Edit')
            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h1 class="no-margin text-light">
                        <i class="icon-file-plus position-left"></i> Retainer Invoice
                        <small>Edit Retainer Invoice.</small>
                    </h1>
                </div>
            </div>
        ...
        <div class="content no-border no-padding">
            ...
            <div class="panel panel-flat no-border no-shadow no-padding">
                ...
                <div class="panel-body no-padding">
                    ...
                    <form id="txn_form" action="{{route('accounting.sales.retainer-invoices.update', $txn->id)}}" method="post" class="form-horizontal" data-edit="true" style="margin-bottom: 100px;">
                ...
                <div class="navbar-collapse collapse" id="navbar-second">
                    ...
                    <div class="navbar-text">
                        ...
                        <div class="btn-group dropup btn-xs btn-group-animated no-padding mr-20">
                            <button type="button" class="btn btn-danger btn-xs pr-20 pl-20 submit_txn_form" data-onsuccess="{{route('accounting.sales.retainer-invoices.show', $txn->id)}}"><i class="icon-cog5 position-left"></i> Update {{$entree->name}}</button>
                            {{--
                            <button type="button" class="btn btn-danger  btn-xs dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></button>
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="" class="submit_txn_form" data-onsuccess=""><i class="icon-menu7"></i> Save only</a></li>
