...
@section('head')
    <script src="{{ mix('/template/limitless/layout_2/LTR/default/assets/mix/retainer_invoice.js') }}"></script>
@endsection
        ...
        <div class="sidebar-content" style="width: 389px;">
            ...
            <div class="page-header" style="border-bottom: 1px solid #ddd;">
                <div class="page-header-content">
                    <div class="page-title clearfix">
                        ...
                        <button type="button" href="#" class="btn btn-link pull-left text-semibold">All Retainer Invoices</button>

                        <button data-href="{{route('accounting.sales.retainer-invoices.create')}}" type="button" class="btn btn-danger pull-right"><i class="icon-plus22"></i> New</button>
            ...
            <div class="panel panel-flat no-border ">
                ...
                <div class="table-responsive no-border datatable-invoices">
                    <table class="rg_datatable_sidebar table table-hover text-nowrap" data-ajax="{{route('accounting.sales.retainer-invoices.datatables')}}" data-txn-id="{{$txn->id}}">
                        <thead class="hidden">
                        <tr>
                            <th>RETAINER INVOICES</th>
            ...
            <div class="page-title clearfix text-right">
                ...
                <div class="btn-group pull-left mr-20">
                    ...
                    <ul class="dropdown-menu dropdown-menu-left">
                        ...
                        <li class="divider"></li>
                        <li><a href="{{route('accounting.sales.retainer-invoices.destroy', $txn->id)}}" class="text-danger rg-ajax-accounting-sales-retainer-invoice-destroy" data-callback="{{route('accounting.sales.retainer-invoices.index')}}"><i class="icon-trash"></i> Delete transaction</a></li>
                    </ul>
                </div>
                ...
                <div class="btn-group pull-right">
                    <button data-href="{{route('accounting.sales.retainer-invoices.create')}}" type="button" class="btn btn-danger"><i class="icon-plus22"></i> New Retainer Invoice</button>
                    <button data-href="{{route('accounting.sales.retainer-invoices.edit', $txn->id)}}" type="button" class="btn btn-default btn-icon"><i class="icon-pencil3"></i></button>
                    ...
                    <a href="{{route('accounting.sales.retainer-invoices.index')}}" class="btn btn-icon btn-default"><i class="icon-cross"></i> Back</a>
