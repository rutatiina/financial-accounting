...
@section('title', 'Goods Returned Note ::  Create')
                                ...
                                <div class="max-width-1040">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="expiry_date" value="" class="form-control input-roundless daterange-single-empty" placeholder="Expiry date">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tr class="items_row_template hidden">
                                            <td class="td_item_selector no-padding rg_select2_border_none">
                                                <select
                                                        ...
                                                        data-url="{{url('items/select2-data/inventory')}}">
                                                    <option></option>
                                                </select>
                ...
                <div class="navbar-collapse collapse" id="navbar-second">
                    ...
                    <div class="navbar-text">
                        ...
                        <div class="btn-group dropup btn-xs btn-group-animated no-padding mr-20">
                            <button type="button" class="btn btn-danger btn-xs pr-20 pl-20 submit_txn_form" data-onsuccess=""><i class="icon-cog5 position-left"></i> Create Goods Returned Note</button>
