...
@section('title', 'Goods Returned Notes')
    ...
    <div class="content-wrapper">
                ...
                <ul class="nav navbar-nav">
                    <li class="active">
                        <button type="button" class="btn btn-link text-primary text-semibold rg_datatable_selected_export_to_excel"
                            data-href="{{route('accounting.inventory.goods-returned-notes.export-to-excel')}}">
            ...
            <div class="page-header-content">
                <div class="page-title clearfix">
                    <h1 class="pull-left no-margin text-light">
                        <i class="icon-file-plus position-left"></i> Goods returned note(s)
                        <small>Make an offer to a customer</small>
                    </h1>
                    <div class="pull-right">
                        <a href="{{route('accounting.inventory.goods-returned-notes.create')}}" type="button" class="btn btn-danger pr-20"><i class="icon-plus22"></i> New Goods returned note </a>
                    </div>
                </div>
            </div>
        ...
        <div class="content no-padding">
            ...
            <div class="panel panel-flat no-border no-shadow">
                ...
                <table class="rg-datatable-txns-table table datatable-pagination" data-ajax="{{route('accounting.inventory.goods-returned-notes.datatables')}}">
                    <thead>
                    <tr>
                        <th width="12"></th>
                        <th>DATE</th>
