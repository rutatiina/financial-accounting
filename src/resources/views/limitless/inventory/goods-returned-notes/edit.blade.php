...
@section('title', 'Goods Returned Note ::  Edit')
        ...
        <div class="content no-border no-padding">
            ...
            <div class="panel panel-flat no-border no-shadow no-padding">
                ...
                <div class="panel-body no-padding">
                    ...
                    <form id="txn_form"
                          action="{{route('accounting.inventory.goods-returned-notes.update', $txn->id)}}"
                          method="post"
                ...
                <div class="navbar-collapse collapse" id="navbar-second">
                    ...
                    <div class="navbar-text">
                        ...
                        <div class="btn-group dropup btn-xs btn-group-animated no-padding mr-20">
                            <button type="button" class="btn btn-danger btn-xs pr-20 pl-20 submit_txn_form" data-onsuccess="{{route('accounting.inventory.goods-returned-notes.show', $txn->id)}}"><i class="icon-cog5 position-left"></i> Update Goods Returened Note</button>
