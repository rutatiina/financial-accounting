        ...
        <div class="sidebar-content" style="width: 389px;">
                ...
                <div class="page-header-content">
                    <div class="page-title clearfix">
                        ...
                        <div class="btn-group pull-left">
                            <a href="#" class="btn btn-link dropdown-toggle text-semibold">All Good Issued Notes</a>
                        </div>

                        <button data-href="{{route('accounting.inventory.goods-issued-notes.create')}}" type="button" class="btn btn-danger btn-sm pull-right"><i class="icon-plus22"></i> New</button>
            ...
            <div class="panel panel-flat no-border ">
                ...
                <div class="table-responsive no-border datatable-invoices">
                    <table class="rg_datatable_sidebar table table-hover text-nowrap" data-ajax="{{route('accounting.inventory.goods-issued-notes.datatables')}}" data-txn-id="{{$txn->id}}">
                        <thead class="hidden">
                        <tr>
                            <th>GOOD ISSUED NOTES</th>
                ...
                <div class="page-title clearfix text-right">
                    ...
                    <div class="btn-group pull-left mr-20">
                        ...
                        <ul class="dropdown-menu dropdown-menu-left">
                            ...
                            <li class="divider"></li>
                            <li><a href="{{route('accounting.inventory.goods-issued-notes.destroy', $txn->id)}}" class="text-danger rg-ajax-accounting-sales-estimate-destroy" data-callback="{{route('accounting.inventory.goods-issued-notes.index')}}"><i class="icon-trash"></i> Delete transaction</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="btn-group pull-right">
                        ...
                        <button data-href="{{route('accounting.inventory.goods-issued-notes.edit', $txn->id)}}" type="button" class="btn btn-default btn-icon"><i class="icon-pencil3"></i></button>
                        ...
                        <a href="{{route('accounting.inventory.goods-issued-notes.index')}}" class="btn btn-icon btn-default"><i class="icon-cross"></i> Back</a>
                    </div>
            ...
            <div class="panel panel-flat no-border no-shadow">
                ...
                @if (empty($txn))
                    <div class="panel-body no-padding">
                        <div class="col-md-8">
                            <button data-href="/inventory/goods_issued_note/" type="button" class="btn btn-danger"><i class="icon-plus22"></i> New Goods issued note</button>
                            <hr/>
                        ...
                        <div class="panel panel-white">
                            <div class="panel-heading hidden-print">
                                ...
                                <div class="heading-elements">
                                    <a href="{{route('accounting.inventory.goods-issued-notes.copy', $txn->id)}}" class="btn btn-default btn-xs heading-btn"><i class="icon-file-check position-left"></i> Copy</a>
