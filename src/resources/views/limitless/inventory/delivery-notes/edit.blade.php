...
@section('title', 'Delivery Note ::  Edit')
            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h1 class="no-margin text-light">
                        <i class="icon-file-plus position-left"></i> Delivery note
                        <small>Items / Goods delivered to the contact.</small>
                    </h1>
                </div>
            </div>
        ...
        <div class="content no-border no-padding">
            ...
            <div class="panel panel-flat no-border no-shadow no-padding">
                ...
                <div class="panel-body no-padding">
                    ...
                    <form id="txn_form"
                          action="{{route('accounting.inventory.delivery-notes.update', $txn->id)}}"
                          method="post"
                        ...
                        <input type="hidden" name="exchange_rate" value="1" />{{--Multi-currency is no enabled on inventory--}}
                        ...
                        <fieldset class="" style="background: #fcfcfc; border-top: 1px solid #ddd; border-bottom: 1px solid #eee;">
                            ...
                            <div class="form-group">
                                <div class="max-width-1040">
                                    ...
                                    <div class="col-lg-5">
                                            <select class="select-search" name="contact_id" data-placeholder="Select customer ..." data-allow-clear="true" data-value="<?php echo @$txn['contact_id']; ?>">
                                                <option></option>
                                    ...
                                    <div id="contact_currency" class="col-lg-2 no-padding-left {{(empty($txn['contact']['currency'])) ? 'hidden' : '' }}">
                                        <div class="input-group hidden"><!-- the quote_currency is not needed  -->
                                            <select id="quote_currency_xxx" name="quote_currency_xxx" class="select input-roundless no-border-left"></select>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="max-width-1040">
                                    <table class="table table-bordered no-border-left no-border-right no-border-bottom">
                                        ...
                                        <tr>
                                            <th width="auto" class="p-10 rg-eee text-bold">Item / description</th>
                                            <th width="15%" class="p-10 rg-eee text-right text-bold">Quantity</th>
                                        </tr>
                                        </thead>
                                    ...
                                    <table class="table table-bordered no-border-left no-border-right no-border-bottom no-border-top">
                                        <tbody>
                                            <tr>
                                                <td class="no-border text-bold"><a href="javascript:rg_txn.new_item();" colspan="2">+ Add another line</a></td>
                                            </tr>
                                        </tbody>
                ...
                <div class="navbar-collapse collapse" id="navbar-second">
                    ...
                    <div class="navbar-text">
                        ...
                        <div class="btn-group dropup btn-xs btn-group-animated no-padding mr-20">
                            <button type="button" class="btn btn-danger btn-xs pr-20 pl-20 submit_txn_form" data-onsuccess="{{route('accounting.inventory.delivery-notes.show', $txn->id)}}"><i class="icon-cog5 position-left"></i> Update Delivery Note</button>
