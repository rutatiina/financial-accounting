            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Sales Order Details</span>
                    </div>
    ...
    export default {
        ...
        watch: {
            '$route.query.page': function (page) {
                this.tableData.url = '/financial-accounts/reports/sales-order-details' + '?page=' + page;
            }
        },
        mounted() {
            ...
            if (this.$route.query.page === undefined) {
                this.tableData.url = '/financial-accounts/reports/sales-order-details';
            } else {
                this.tableData.url = '/financial-accounts/reports/sales-order-details' + '?page='+this.$route.query.page;
            }
