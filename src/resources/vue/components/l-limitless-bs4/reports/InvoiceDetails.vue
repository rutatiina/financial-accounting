    ...
    export default {
        ...
        watch: {
            '$route.query.page': function (page) {
                this.tableData.url = '/accounting/reports/invoice-details' + '?page=' + page;
            }
        },
        mounted() {
            ...
            if (this.$route.query.page === undefined) {
                this.tableData.url = '/accounting/reports/invoice-details';
            } else {
                this.tableData.url = '/accounting/reports/invoice-details' + '?page='+this.$route.query.page;
            }
