            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Vendor Credits Details</span>
                    </div>
        ...
        <div class="content border-0 p-0">
            ...
            <div class="card max-width-1280 shadow-none border-0 m-auto">
                <div class="card-header text-center">
                    ...
                    <h3 class="card-title">Vendor Credits Details</h3>
                    <p>Basis: Accrual</p>
    ...
    export default {
        ...
        watch: {
            '$route.query.page': function (page) {
                this.tableData.url = '/accounting/reports/vendor-credits-details' + '?page=' + page;
            }
        },
        mounted() {
            ...
            if (this.$route.query.page === undefined) {
                this.tableData.url = '/accounting/reports/vendor-credits-details';
            } else {
                this.tableData.url = '/accounting/reports/vendor-credits-details' + '?page='+this.$route.query.page;
            }
