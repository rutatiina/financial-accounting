            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Recurring Invoice Details</span>
                    </div>
        ...
        <div class="content border-0 p-0">
            ...
            <div class="card max-width-1280 shadow-none border-0 m-auto">
                <div class="card-header text-center">
                    ...
                    <h3 class="card-title">Recurring Invoice Details</h3>
                    <p>Basis: Accrual</p>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr v-for="row in tableData.payload.data">
                                ...
                                <td><span v-if="row.recurring">{{row.recurring.frequency}}</span></td>
                                <td><span v-if="row.recurring">{{row.recurring.last_processed}}</span></td>
                                <td><span v-if="row.recurring">{{row.recurring.next_run_date}}</span></td>
                                <td><span v-if="row.recurring">{{row.recurring.end_date}}</span></td>
    ...
    export default {
        ...
        watch: {
            '$route.query.page': function (page) {
                this.tableData.url = '/financial-accounts/reports/recurring-invoice-details' + '?page=' + page;
            }
        },
        mounted() {
            ...
            if (this.$route.query.page === undefined) {
                this.tableData.url = '/financial-accounts/reports/recurring-invoice-details';
            } else {
                this.tableData.url = '/financial-accounts/reports/recurring-invoice-details' + '?page='+this.$route.query.page;
            }
