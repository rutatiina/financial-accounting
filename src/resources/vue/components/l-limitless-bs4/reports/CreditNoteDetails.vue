            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Credit Note Details</span>
                    </div>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th>CREDIT NOTE #</th>
                                <th>CUSTOMER NAME</th>
                                <th class="text-right">CREDIT NOTE AMOUNT</th>
    ...
    export default {
        ...
        watch: {
            '$route.query.page': function (page) {
                this.tableData.url = '/financial-accounts/reports/credit-note-details' + '?page=' + page;
            }
        },
        mounted() {
            ...
            if (this.$route.query.page === undefined) {
                this.tableData.url = '/financial-accounts/reports/credit-note-details';
            } else {
                this.tableData.url = '/financial-accounts/reports/credit-note-details' + '?page='+this.$route.query.page;
            }
