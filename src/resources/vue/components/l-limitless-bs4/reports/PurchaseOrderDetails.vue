            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Purchase Order Details</span>
                    </div>
    ...
    export default {
        ...
        watch: {
            '$route.query.page': function (page) {
                this.tableData.url = '/financial-accounts/reports/purchase-order-details' + '?page=' + page;
            }
        },
        mounted() {
            ...
            if (this.$route.query.page === undefined) {
                this.tableData.url = '/financial-accounts/reports/purchase-order-details';
            } else {
                this.tableData.url = '/financial-accounts/reports/purchase-order-details' + '?page='+this.$route.query.page;
            }
