...
rg_retainer_invoices = function() {
        ...
        var dtable = _table.DataTable({
            ...
            fnRowCallback: function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                ...
                var action = '<ul class="icons-list">\
                    <li><a href="/sales/retainer_invoices/' + aData['id'] + '"><i class="icon-newspaper2"></i></a></li> \
                    <li><a href="/sales/retainer_invoice/' + aData['id'] + '"><i class="icon-pencil7"></i></a></li> \
                </ul>';
    ...
    var init = function() {
        ...
        jQ_body.on('click', '.rg-ajax-accounting-sales-retainer-invoice-destroy', function (ev) {
            ...
            rutatiina.transaction_delete({
                ...
                title: "Are you sure?",
                text: "You will not be able to recover this Retainer Invoice!",
                type: "warning",
                confirmButtonText: "Yes, delete it!",
                cancelButtonText: "No, cancel pls!"
            });
