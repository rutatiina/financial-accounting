 ...
 */
rg_recurring_invoices = function() {
    ...
    var datatable_txns = function() {
        ...
        var dtable = _table.DataTable({
            ...
            //bFilter: false,
            aoColumns: [
                { "mDataProp": 'id', "sClass": "pl-15 pr-10 " },
                { "mDataProp": null, "sClass": "pl-10 pr-15 text-center" },
                { "mDataProp": "recurring.next_run_date", "sClass": "pointer pl-5 text-capitalize" },
                { "mDataProp": "recurring.measurement", "sClass": "pointer text-capitalize" },
                { "mDataProp": "recurring.start_date", "sClass": "pointer text-capitalize" },
                { "mDataProp": "recurring.end_date", "sClass": "pointer text-capitalize" },
            ...
            fnRowCallback: function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                ...
                if (aData.recurring.recur) {
                    l = '\
                    <a href="' + aData.link_copy + '?date='+aData.recurring.next_run_date+'" title="Create Invoice">\
                        <i class="icon-stack3 text-danger"></i>\
                    </a>';
                } else {
                    l = '\
                    <a href="' + aData.link_copy + '?date='+aData.recurring.next_run_date+'" title="Invoice due on '+aData.recurring.next_run_date+'">\
                        <i class="icon-stack3 text-muted"></i>\
                    </a>';
                }
    ...
    var init = function() {
        ...
        jQ_body.on('click', '.rg-ajax-accounting-sales-recurring-invoice-destroy', function (ev) {
            ...
            rutatiina.transaction_delete({
                ...
                title: "Are you sure?",
                text: "You will not be able to recover this Recurring Invoice!",
                type: "warning",
                confirmButtonText: "Yes, delete it!",
                cancelButtonText: "No, cancel pls!"
            });
