...
rg_credit_notes = function() {
        ...
        var dtable = _table.DataTable({
            ...
            fnRowCallback: function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
               ...
               var action = '<ul class="icons-list">\
                    ...
                    <li><a href="/sales/credit_note/' + aData['id'] + '"><i class="icon-pencil7"></i></a></li> \
    ...
    var init = function() {
        ...
        jQ_body.on('click', '.rg-ajax-accounting-sales-credit-note-destroy', function (ev) {
