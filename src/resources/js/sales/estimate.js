...
rg_estimates = function() {
        ...
        var dtable = _table.DataTable({
            ...
            fnRowCallback: function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
                ...
                var column_three = '<h6 class="no-margin text-right">' +
                    '<small>'+aData['quote_currency']+'</small> ' + rg_number_format(aData['total'], rg_decimal_places) +
    ...
    var datatable_txns = function() {
        ...
        var dtable = _table.DataTable({
            ...
            fnRowCallback: function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                ...
                var action = '<ul class="icons-list">\
                    <li><a href="/sales/estimates/' + aData['id'] + '"><i class="icon-newspaper2"></i></a></li> \
                    <li><a href="/sales/estimate/' + aData['id'] + '"><i class="icon-pencil7"></i></a></li> \
                </ul>';
        ...
        function format ( data ) {
            var p = '\
            <form id="txn_process_to_'+data.id+'" class="txn_process_to" action="'+data.link_process+'" method="post" class="form-horizontal" target="_blank">\
            ...
            </form>'; //<option value="invoice_receipt">Receive Payment</option>
    ...
    var init = function() {
        ...
        jQ_body.on('click', '.rg-ajax-accounting-sales-estimate-destroy', function (ev) {
