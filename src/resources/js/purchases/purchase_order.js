    ...
    var datatable_txns = function() {
        ...
        var dtable = _table.DataTable({
            ...
            aoColumns: [
                ...
                { "mDataProp": 'total', "sClass": "text-right text-semibold pointer" },
        ...
        function format ( data ) {
            var p = '\
            <form id="txn_process_to_'+data.id+'" class="txn_process_to" action="/purchases/process_transaction/" method="post" class="form-horizontal">\
